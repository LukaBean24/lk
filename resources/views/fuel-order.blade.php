    ...
    <x-page-content>
        <form action="/fuel-order" method="POST"
            ...
            <div class="w-full h-20 flex justify-center items-start">
                <p class="text-white text-3xl">საწვავის შეკვეთა</p>
            </div>
            ...
            <div class="w-full h-1/6 flex flex-col justify-center items-center mt-8">
                <button type="submit"
                    class="w-2/3 h-2/3 border-2 border-white rounded-xl text-white text-xl hover:bg-white hover:text-lk-main duration-200">შეკვეთა</button>
            </div>
        </form>
